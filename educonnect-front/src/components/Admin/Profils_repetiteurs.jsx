...
//     tutor.adresse.toLowerCase().includes(searchTerm.toLowerCase())
//   );
...
//                     </div>
//                   </td>
//                   <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{tutor.adresse}</td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="h-10 w-10 rounded-full overflow-hidden bg-gray-200 flex items-center justify-center">
                        {tutor.photo ? (
                          <img src={`/storage/${tutor.photo}`} alt="profil" className="h-10 w-10 object-cover" />
                        ) : (
